    ...
    constructor(owner,uri,definer){
        ...
        if(typeof definer == 'function'){
            ...
            if(definer.name=='cjs'){
                ...
                this.require = path=>{
                    if(path[0]=='.'){
                        path = Loader.resolve(Loader.dirname(this.uri), path);
                    }
                    var mid = owner.loader.module(path).uri;
                    var exports =  this.owner.modules[mid];
                    return exports;
                };
            }else{
                Object.defineProperty(this,'type',{
        ...
        Declaration.accessor(this.owner.modules,this.uri,{
            ...
            initializer     :function(){
                ...
                if(self.type=='cjs'){
                    if (!self.initializing) {
                        self.initializing = true;
                        definer(config.url, config.url, self.require, self, self.exports, self, babelHelpers);
                    }
                    delete self.initializing;
                }
                return self.exports;
