...
import n from "./node/index";
import * as t from "../types/index";

import * as templateLiterals from "./generators/template-literals";
import * as comprehensions   from "./generators/comprehensions";
import * as expressions      from "./generators/expressions";
import * as statements       from "./generators/statements";
import * as classes          from "./generators/classes";
import * as methods          from "./generators/methods";
import * as modules          from "./generators/modules";
import * as types            from "./generators/types";
import * as flow             from "./generators/flow";
import * as base             from "./generators/base";
import * as jsx              from "./generators/jsx";
...
Object.getOwnPropertyNames(Buffer.prototype).forEach(key=>{
  var fn = Buffer.prototype[key];
