...
var ForOfTemplate = util.template("for-of",`
...
`);
var ForOfArray = util.template("for-of",`
  for (var KEY = 0; KEY < ARR.length; KEY++) BODY;
`);
var ForOfLoose = util.template("for-of",`
  for (var LOOP_OBJECT = OBJECT,IS_ARRAY = Array.isArray(LOOP_OBJECT),INDEX = 0,LOOP_OBJECT = IS_ARRAY ? LOOP_OBJECT : LOOP_OBJECT[Symbol.iterator]();;) {
    var ID;
    if (IS_ARRAY) {
